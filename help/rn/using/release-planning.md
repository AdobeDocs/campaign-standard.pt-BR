...
Informações detalhadas sobre esta versão estão disponíveis no [Notas de versão antecipadas](../../rn/using/e-release-notes.md) na data de atualização do Estágio.
