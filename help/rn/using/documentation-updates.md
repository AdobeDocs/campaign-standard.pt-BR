...
A nova integração Campaign Standard - Microsoft Dynamics 365 está disponível. [Leia mais](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)
...
A seção de limitações **de mensagens** transacionais foi movida [aqui](../../channels/using/transactional-messaging-limitations.md)

A seção **Preparando o envio** foi movida [aqui](../../sending/using/preparing-the-send.md)
...
A documentação sobre Configuração de um aplicativo para dispositivo móvel usando os SDKs da Adobe Experience Platform está agora disponível na documentação principal. Ela também contém informações sobre o fluxo de trabalho técnico Sincronizar AEPSDK do aplicativo para dispositivo móvel do Launch. [Leia mais](../../administration/using/configuring-a-mobile-application.md)
...
A documentação da integração do Microsoft Dynamics 365 com o Adobe Campaign Standard está agora disponível na documentação principal. [Leia mais](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)

Recursos adicionais foram adicionados à página inicial de documentação. [Leia mais](../../campaign-standard-home.md)

Informações sobre o Experience Cloud ID Service (ECID) foram adicionadas à documentação do Conector de dados da Adobe Experience Platform. [Leia mais](../../developing/using/aep-about-data-connector.md#key-concepts)
...
A seção Exclusão de uma mensagem transacional foi aprimorada e esclarecida. [Leia mais](../../channels/using/event-transactional-messages.md#deleting-a-transactional-message)
...
Foram adicionadas práticas recomendadas em relação a mensagens transacionais e à exclusão de eventos em tempo real não utilizados. [Leia mais](../../administration/using/configuring-transactional-messaging.md#creating-an-event)
...
A seção Configuração de mensagens transacionais foi atualizada com informações adicionais sobre os direitos necessários para editar configurações de eventos e sobre como enriquecer coleções em mensagens transacionais. [Leia mais](../../administration/using/configuring-transactional-messaging.md).
...
Uma nova seção que descreve como excluir uma configuração de evento está agora disponível. [Leia mais](../../administration/using/configuring-transactional-messaging.md#deleting-an-event)
...
A documentação do Designer de email do Campaign e de páginas relacionadas foi atualizada com o objetivo de refletir a depreciação do SDK da Adobe Creative. [Leia mais](https://helpx.adobe.com/br/campaign/kb/acs-deprecated-and-removed-features.html)
...
Conector de dados da Adobe Experience Platform (beta) - [Leia mais](../../developing/using/aep-about-data-connector.md)

Destinos do público (beta) - [Leia mais](../../audiences/using/aep-about-audience-destinations-service.md)
...
Um novo caso de uso que descreve como criar um grupo de controle usando um fluxo de trabalho no Campaign Standard foi adicionado. [Leia mais](../../automating/using/workflow-control-group.md)
...
A documentação do Painel de controle do Campaign foi integrada ao novo conjunto de documentação colaborativa. [Leia mais](https://docs.adobe.com/content/help/pt-BR/control-panel/using/control-panel-home.html)
...
O guia de introdução à Criação de um email personalizado foi movido e atualizado. [Leia mais](https://helpx.adobe.com/br/campaign/kb/acs-get-started-with-emails.html)
...
A seção Mensagens transacionais foi modificada com as atualizações mais recentes da interface, incluindo edição de conteúdo com o Designer de email. [Leia mais](../../channels/using/event-transactional-messages.md)
...
Um novo exemplo que mostra como enviar um email contendo dados adicionais recuperados de uma atividade de carregamento de arquivo foi adicionado. [Leia mais](../../automating/using/load-file.md#example-2-email-with-enriched-fields)
...
Um novo artigo de ajuda foi adicionado, com informações relacionadas a gerenciamento de subdomínios e gerenciamento de certificados no Painel de controle do Campaign. [Leia mais](https://docs.adobe.com/content/help/pt-BR/control-panel/using/subdomains-and-certificates/subdomains-branding.html)
...
Um conjunto de novos artigos de ajuda foi criado sobre a implementação e o uso do conector do Microsoft Dynamics 365. Observe que esse recurso está atualmente com a Disponibilidade limitada.[Leia mais](../../integrating/using/working-with-campaign-standard-and-microsoft-dynamics-365.md)

Uma observação foi adicionada na seção [Chamado de fluxo de trabalho com parâmetros](../../automating/using/calling-a-workflow-with-external-parameters.md) sobre a preparação do delivery e o período de agregação.
...
Uma recomendação foi adicionada sobre o uso de deliveries recorrentes sem período de agregação ao chamar um fluxo de trabalho com parâmetros. [Leia mais](../../automating/using/calling-a-workflow-with-external-parameters.md)
...
Painel de controle do Campaign - [Leia mais](https://docs.adobe.com/content/help/pt-BR/control-panel/using/control-panel-home.html)
...
Aprimoramento do fluxo de trabalho - Adicione um payload à atividade de sinal externo - [Leia mais](../../automating/using/calling-a-workflow-with-external-parameters.md)
...
A tabela de compatibilidade de relatórios dinâmicos foi adicionada para um melhor entendimento da compatibilidade entre dimensões e métricas. [Leia mais](https://docs.campaign.adobe.com/doc/standard/en/Technotes/dynamic_report_compatibility.pdf)
...
Uma nova seção foi adicionada para descrever o processo específico de repetição de mensagens transacionais. [Leia mais](../../channels/using/event-transactional-messages.md#transactional-message-retry-process)
...
A página de Recursos obsoletos e removidos foi atualizada. [Leia mais](https://helpx.adobe.com/br/campaign/kb/acs-deprecated-and-removed-features.html)
...
Uma nova nota técnica foi adicionada sobre como exibir uma imagem de uma notificação por push do Adobe Campaign Standard. [Leia mais](https://helpx.adobe.com/content/help/br/campaign/kb/display-image-push.html)

Uma nova nota técnica sobre implementação do rastreamento de notificação por push foi adicionada. [Leia mais](https://helpx.adobe.com/content/help/br/campaign/kb/push-tracking.html)
...
Foram adicionadas informações sobre a nova opção das atividades de Query ( [Leia mais](../../automating/using/query.md)) e Segmentação ( [Leia mais](../../automating/using/segmentation.md)), que permitem adicionar uma transição de saída após a atividade, caso a atividade não recupere dados.
...
Os vídeos foram atualizados e movidos, e agora encontram-se [aqui](https://docs.adobe.com/content/help/pt-BR/campaign-standard-learn/tutorials/overview.translate.html).
...
Adição de um exemplo na seção da atividade de query sobre como segmentar perfis que clicaram em um link específico em um delivery. [Leia mais](../../automating/using/query.md#targeting-profiles-who-clicked-a-specific-link-)
...
Atualização do guia passo a passo de práticas recomendadas do delivery. [Leia mais](https://helpx.adobe.com/br/campaign/kb/delivery-best-practices.html)
...
Uma nova opção que permite obter desempenho ao definir muitos dados adicionais em um **[!UICONTROL Query]** está agora disponível. [Leia mais](../../automating/using/query.md)
...
Uma nota técnica foi adicionada explicando a estrutura do payload recebido em um aplicativo móvel. [Leia mais.](https://helpx.adobe.com/br/campaign/kb/understanding-campaign-standard-push-notifications-payload-struc.html)

A [seção](https://helpx.adobe.com/br/campaign/kb/configuring-app-sdkv4.html) Configuração do canal de push foi atualizada com novos dados de payload na versão do OS a serem adicionados ao definir postbacks na interface do Adobe Mobile Services.
...
A seção sobre a atividade do fluxo de trabalho Transfer file foi atualizada. [Leia mais](../../automating/using/transfer-file.md)

Informações foram adicionadas na opção &quot;Request confirmation before sending messages&quot;, na atividade do fluxo de trabalho Email Delivery. [Leia mais](../../automating/using/email-delivery.md)
...
Integração do Dreamweaver (Labs) - [Leia mais](https://docs.adobe.com/content/help/pt-BR/campaign-standard-learn/tutorials/designing-content/email-designer/dreamweaver-integration.translate.html)
...
Descubra exemplos das novas atividades de fluxo de trabalho [Leitura de público](../../automating/using/read-audience.md) e [Sinal externo](../../automating/using/external-signal.md).
...
Atividade do fluxo de trabalho Query incremental: novo modo incremental - [Leia mais](../../automating/using/incremental-query.md)

Atualização da atividade do fluxo de trabalho Scheduler - [Leia mais](../../automating/using/scheduler.md)

Alteração de URL: Serviço principal Assets - [Leia mais](../../integrating/using/working-with-campaign-and-assets-core-service.md)

Alteração de URL: Serviço principal Pessoas - [Leia mais](../../integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)
