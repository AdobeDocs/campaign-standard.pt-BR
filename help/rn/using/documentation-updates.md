...
Uma nova seção foi adicionada sobre como trabalhar com Fontes e Destinos da Adobe Experience Platform para compartilhar dados entre o Campaign Standard e o a Plataforma de dados do cliente em tempo real (RTCDP). [Leia mais](../../integrating/using/get-started-sources-destinations.md)

## Março de 2021 {#doc-updates-march-2021}

A página &quot;Opções de ajuda e suporte&quot; do Campaign Standard foi integrada à documentação principal. [Leia mais](../../support.md)
...
Os vídeos foram atualizados e movidos, e agora encontram-se [aqui](https://docs.adobe.com/content/help/pt-BR/campaign-standard-learn/tutorials/overview.html).
...
Regulamento Geral sobre a Proteção de Dados da União Europeia (GDPR) - [Leia mais](https://experienceleague.adobe.com/docs/campaign-classic/using/getting-started/privacy/privacy-management.html?lang=pt-BR)
...
Integração do Dreamweaver (Labs) - [Leia mais](https://docs.adobe.com/content/help/pt-BR/campaign-standard-learn/tutorials/designing-content/email-designer/dreamweaver-integration.html)
