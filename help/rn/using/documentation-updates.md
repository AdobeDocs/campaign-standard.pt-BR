...
Foi realizada uma observação para especificar que o envio de provas usando substituição de perfil adicionará registros aos logs dos perfis selecionados. [Saiba mais](../../sending/using/testing-messages-using-target.md)
