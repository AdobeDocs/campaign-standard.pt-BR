...
Uma observação foi adicionada para recomendar a prevenção de espaços em branco no campo de ID dos deliveries. [Leia mais](../../channels/using/creating-an-email.md)
