...
* Amostra da solicitação GET para recuperar emails no banco de dados ordenados alfabeticamente.
...
* Amostra da solicitação GET para recuperar o email no banco de dados em uma ordem alfabética decrescente.
