...
A Adobe Campaign Standard fornece APIs que permitem a integração de sistemas existentes com a plataforma de Campanha para solucionar problemas reais em tempo real.
