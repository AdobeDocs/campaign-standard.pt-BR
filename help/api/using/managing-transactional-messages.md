...
>[!NOTE]
>
>A configuração do evento está detalhada em [esta seção](../../channels/using/configuring-transactional-event.md).
...
* **&lt;ORGANIZAÇÃO>**: sua ID de ORGANIZAÇÃO pessoal. Consulte [esta seção](../../api/using/must-read.md).
...
* **paused**: o processo de evento está sendo pausado. Ele não é mais processado, mas mantido em fila no banco de dados do Adobe Campaign. Para obter mais informações, consulte [esta seção](../../channels/using/publishing-transactional-message.md#suspending-a-transactional-message-publication).
