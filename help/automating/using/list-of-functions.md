...
As funções de agregação só estão disponíveis ao [adicionar dados adicionais](../../automating/using/query.md#enriching-data) atividade **[!UICONTROL Query]** de um fluxo de trabalho.
