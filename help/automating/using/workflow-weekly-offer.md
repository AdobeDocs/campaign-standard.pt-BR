...
1. Em **[!UICONTROL Activities]** > **[!UICONTROL Targeting]**, para selecionar destinatários, arraste e solte uma atividade de [Consulta](../../automating/using/query.md) e clique duas vezes nela.
...
1. Em **[!UICONTROL Activities]** > **[!UICONTROL Channels]**, arraste e solte uma atividade de [Entrega de email](../../automating/using/email-delivery.md).
