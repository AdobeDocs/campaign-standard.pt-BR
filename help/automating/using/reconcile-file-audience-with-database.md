...
* A [Ler público](../../automating/using/read-audience.md) A atividade faz upload do público-alvo File criado no fluxo de trabalho de importação. Os dados do público-alvo ainda não foram reconciliados com o banco de dados do Adobe Campaign.
