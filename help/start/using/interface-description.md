...
* **[!UICONTROL Templates]**, que contém os submenus para cada tipo de modelo - para obter mais informações, consulte a seção [Gerenciar modelos](../../start/using/about-templates.md) .
