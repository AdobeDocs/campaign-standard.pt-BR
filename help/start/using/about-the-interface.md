...
A fim de se adaptar às diferentes utilizações e às novas funcionalidades oferecidas, a interface do utilizador do Adobe Campaign e todos os seus elementos são atualizados regularmente. Você pode notar algumas diferenças entre a versão que está usando e as telas mostradas neste documento.
