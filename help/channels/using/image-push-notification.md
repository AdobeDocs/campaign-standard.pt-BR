---
title: Exibir uma imagem de uma notificação por push do Adobe Campaign Standard
...
# Exibir uma imagem de uma notificação por push do Adobe Campaign Standard {#image-push}
...
Para enviar notificações por push com um aplicativo SDK da Experience Cloud, é necessário configurar um aplicativo móvel no Adobe Experience Platform Launch e configurá-lo no Adobe Campaign. Para obter mais informações, consulte esta [página](https://helpx.adobe.com/campaign/kb/configuring-app-sdk.html#ChannelspecificapplicationconfigurationinAdobeCampaign).
