...
* Aplicativos iOS: seção **Manuseio de Notificações** Remotas em Notificações [](https://developer.apple.com/library/archive/documentation/NetworkingInternet/Conceptual/RemoteNotificationsPG/HandlingRemoteNotifications.html)Remotas.
* Aplicativos Android: Mensagens de [recebimento em um aplicativo cliente Android](https://firebase.google.com/docs/cloud-messaging/android/receive)
