...
1. Ter acesso ao Adobe Analytics for Mobile. Verifique seu contrato de licença ou entre em contato com o executivo da sua conta da Adobe para obter mais informações.
...
1. Execute a configuração específica do aplicativo móvel:
   ...
   * Integre o Experience Cloud Mobile SDK ao seu aplicativo móvel. Consulte [Integrando o SDK em um aplicativo para dispositivos móveis](#integrating-the-sdk-into-a-mobile-application).
...
1. Clique no logotipo **Adobe**, no canto superior esquerdo, e selecione **[!UICONTROL Administration]** > **[!UICONTROL Channels]** > **[!UICONTROL Mobile app]**.
...
* A URL **[!UICONTROL Collect PII endpoint]** é usada para coletar as Experience Cloud IDs e os tokens de registro dos usuários do aplicativo móvel quando ele é iniciado. Quando um usuário faz logon no aplicativo usando credenciais como email, nome, sobrenome etc., esses dados também são coletados e usados para reconciliar o token de registro do usuário com um perfil do Adobe Campaign.
...
1. Acesse a interface do Adobe Mobile Services.
