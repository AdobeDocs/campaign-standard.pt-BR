...
1. Definição dos pontos de interesse em locais. See [Create a Point of Interest](https://placesdocs.com/places-services-by-adobe-documentation/places-database-management-1/managing-pois-in-the-places-ui#create-a-poi).
...
Uma lista dos assinantes do aplicativo também é exibida. Os assinantes são todos os usuários que instalaram o aplicativo em seu dispositivo móvel. Os perfis de banco de dados do Adobe Campaign são identificados com um token de registro.
