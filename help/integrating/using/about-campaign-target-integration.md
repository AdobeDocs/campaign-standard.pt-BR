...
Para obter mais informações sobre a integração entre o Adobe Campaign e o Adobe Target, consulte também [Adobe Target Portal](https://experienceleague.adobe.com/docs/target/using/integrate/campaign-and-target.html?lang=pt-BR).
