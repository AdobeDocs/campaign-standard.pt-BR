...
A página **[!UICONTROL Microsoft Dynamics 365 to Campaign]** mostra uma lista de entidades no Microsoft Dynamics 365 e os recursos personalizados no Adobe Campaign com os quais elas serão sincronizadas. É possível adicionar novos mapeamentos, editar ou excluir mapeamentos existentes.
...
1. Use as listas suspensas para selecionar o Microsoft Dynamics 365 e as tabelas do Campaign a serem mapeadas.
...
* um nome de campo Microsoft Dynamics 365 (que foi adicionado acima na seção mapeamentos de campo),
...
Selecione **Sim** para confirmar que você deseja que os eventos desse tipo fluam para o Microsoft Dynamics 365.
...
O fluxo de trabalho **Aceitar/Recusar** permite identificar o fluxo das informações de aceitação/recusa entre o Microsoft Dynamics 365 e o Adobe Campaign. Isso pressupõe que os dados estejam associados à entidade &quot;contato&quot; da Microsoft Dynamics 365 e ao &quot;perfil&quot; de recurso da Adobe Campaign.
...
Lembre-se de que é necessário clicar em &quot;Salvar&quot; para salvar as seleções. Lembre-se também de que você deve interromper o fluxo de trabalho do **Campaign para o Microsoft Dynamics 365** e, em seguida, clicar em Reproduzir para que a integração incorpore suas alterações.
...
* **[!UICONTROL Disabled]**: quando essa opção é selecionada, nenhuma informação de aceitação/recusa será movida entre o Adobe Campaign e o Microsoft Dynamics 365.
