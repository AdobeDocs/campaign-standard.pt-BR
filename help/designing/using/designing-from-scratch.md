...
description: Descubra como criar emails do zero no Email Designer.
audience: designing
...
1. Adicionar componentes de estrutura para moldar o email. Consulte [Edição da estrutura do email](#defining-the-email-structure).
...
Selecione o **[!UICONTROL Preheader]** editar e completar o conteúdo.
...
Se precisar usar vários botões, em vez de editar cada botão do zero, você poderá duplicar o **[!UICONTROL Button]** usando a barra de ferramentas contextual.
...
Use esse componente para inserir texto no email. É possível ajustar a cor, o estilo e o tamanho do texto no **[!UICONTROL Component Settings]**.

### **[!UICONTROL Divider]**

Use esse componente para inserir uma linha divisória no email. É possível selecionar a cor, o estilo e o tamanho da linha de quebra em **[!UICONTROL Component Settings]**.
...
>[!NOTE]
>
>Um componente de HTML livre pode ser editado com opções limitadas. Se todos os estilos não estiverem incorporados, adicione o CSS correto no **head** do código HTML, caso contrário, o email não responderá. Use o **[!UICONTROL Preview]** para testar a capacidade de resposta do seu conteúdo (consulte [Pré-visualização de mensagens](../../sending/using/previewing-messages.md)).

Para simplesmente tornar um conteúdo externo compatível com o Designer de email, o Adobe recomenda criar uma mensagem do zero e copiar o conteúdo do seu email existente em fragmentos e componentes.

Quando tiver um conteúdo que não pode ser recriado, você pode copiar e colar o código HTML do email original usando o **[!UICONTROL Html]** componente de conteúdo. Familiarize-se com o HTML antes de continuar.
...
Use esse componente para inserir links para páginas de redes sociais no seu email. Você pode selecionar quais links deseja exibir e o tamanho do ícone em **[!UICONTROL Component Settings]**.
...
1. Arraste e solte a **[!UICONTROL Carousel]** dentro de um componente de estrutura.
1. Navegue para selecionar imagens do seu computador.

   ![](assets/des_carousel_browse.png)

1. No **[!UICONTROL Settings]** defina o número de miniaturas que deseja incluir no carrossel.
