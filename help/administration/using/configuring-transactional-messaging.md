...
* O mensagen transacional correspondente é criado automaticamente. Consulte [Introdução às mensagens](../../channels/using/getting-started-with-transactional-msg.md)transacionais.
