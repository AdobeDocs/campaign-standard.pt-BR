...
O relatório **[!UICONTROL Tracking indicators]** contém os indicadores principais para o comportamento de rastreamento após o recebimento de mensagens de email.
...
A tabela **[!UICONTROL Tracking indicators]** e o gráfico **As 5 principais entregas** contêm os dados disponíveis para rastreamento de email, como:
