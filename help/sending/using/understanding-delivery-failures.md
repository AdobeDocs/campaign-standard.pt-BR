...
As mensagens de erro de falha de entrega (ou &quot;Respostas de rejeição SMTP&quot;) são coletadas pela plataforma do Adobe Campaign e, em seguida, processadas e qualificadas como **Difícil**, **Soft** ou **Ignoradas** usando o **[!UICONTROL Delivery log qualification]**banco de dados.
