...
+ Introdução {#getting-started}
   + About Adobe Campaign {#about-adobe-campaign}
      ...
      + [Acompanhamento, monitoramento e relatórios](start/using/tracking--monitoring-and-reporting.md)
      + [Integração com soluções da Adobe](start/using/integrating-with-adobe-solutions.md)
      + [Enriquecendo o banco de dados do Campaign](start/using/enriching-campaign-database.md)
   ...
   + Gerenciamento de modelos {#managing-templates}
      + [Sobre templates](start/using/about-templates.md)
      + [Criação de um novo template](start/using/creating-a-new-template.md)
...
+ Perfis e públicos-alvo {#profiles-and-audiences}
   ...
   + Gerenciamento de subscrições {#managing-subscriptions}
      ...
      + [Confirmando a assinatura de um serviço](audiences/using/confirming-subscription-to-a-service.md)
   + Noções básicas sobre os processos de aceitação e não participação {#understanding-opt-in-and-opt-out-processes}
      ...
      + [Como identificar perfis de opção de não participação para uma entrega](audiences/using/identifying-opt-out-profiles-for-a-delivery.md)
+ Canais de comunicação {#communication-channels}
   ...
   + Landing pages {#landing-pages}
      ...
      + [Sobre modelos de página inicial](channels/using/landing-page-templates.md)
      + [Criação de uma página de aterrissagem](channels/using/designing-a-landing-page.md)
      + [Gerenciamento de dados de formulário da página inicial](channels/using/managing-landing-page-form-data.md)
...
+ Relatório {#reporting}
   ...
   + Lista de relatórios {#list-of-reports}
      + [Definição do período de relatório](reporting/using/defining-the-report-period.md)
      ...
      + [Resumo do delivery](reporting/using/delivery-summary.md)
      + [Taxa de transferência de delivery](reporting/using/delivery-throughput.md)
...
+ Integração com a Adobe Cloud {#integrating-with-adobe-cloud}
   ...
   + Trabalhar com o Campaign e o Analytics {#working-with-campaign-and-analytics}
      + [Sobre a integração do Campaign-Analytics](integrating/using/about-campaign-analytics-integration.md)
      + [Configurar a integração do Campaign-Analytics](integrating/using/configure-campaign-analytics-integration.md)
      + [Dimensões e métricas da campanha no Analytics](integrating/using/campaign-dimensions-and-metrics-in-analytics.md)
   + Trabalhar com o Campaign e o Audience Manager ou os principais serviços das pessoas {#working-with-campaign-and-audience-manager-or-people-core-service}
      + [Sobre o Campaign-Audience Manager ou a integração dos principais serviços do público](integrating/using/about-campaign-audience-manager-or-people-core-service-integration.md)
      ...
      + [Compartilhamento de públicos-alvo com o Audience Manager ou o serviço principal de Pessoas](integrating/using/sharing-audiences-with-audience-manager-or-people-core-service.md)
   ...
   + Trabalhar com o Campaign e o Analytics para dispositivos móveis {#working-with-campaign-and-analytics-for-mobile}
      + [Sobre a integração de dados de Pontos de interesse da campanha](integrating/using/about-campaign-points-of-interest-data-integration.md)
      + [Configuração da integração de dados dos Pontos de interesse da campanha](integrating/using/configuring-campaign-points-of-interest-data-integration.md)
      + [Personalização de mensagens da campanha com dados de Ponto de interesse](integrating/using/personalizing-campaign-messages-with-point-of-interest-data.md)
   + Trabalhar com campanhas e acionadores {#working-with-campaign-and-triggers}
      ...
      + [Testar seus acionadores](integrating/using/testing-your-triggers.md)
      + [Acionadores de Abandono usam casos](integrating/using/abandonment-triggers-use-cases.md)
+ Gerenciamento de processos e dados {#managing-processes-and-data}
   ...
   + Filtros de dados {#filtering-data}
...
+ Desenvolvimento {#developing}
   + Sobre recursos personalizados {#about-custom-resources}
      ...
      + [Monitorando alterações no modelo de dados](developing/using/monitoring-data-model-changes.md)
   + Adicionar ou estender um recurso {#adding-or-extending-a-resource}
      ...
      + [Excluindo um recurso](developing/using/deleting-a-resource.md)
...
+ Administração {#administrating}
   ...
   + Configurações do aplicativo {#application-settings}
      ...
      + [Enviando notificações internas](administration/using/sending-internal-notifications.md)
