...
* **[!UICONTROL Query]**: indica que o público-alvo foi criado usando um [query](../../automating/using/editing-queries.md#about-query-editor) nos dados do banco de dados do Adobe Campaign por meio da lista de públicos-alvo. Os públicos-alvo definidos por um query são recalculados a cada novo uso.
